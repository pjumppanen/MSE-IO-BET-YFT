...
# --- Description --------------------------------------------------------------
OMd@Name          <- "OMyftNEr"
OMd@Label         <- "OMyftNEr" #useful for changing graphics labels
OMd@Date          <- "Jun 2016"
OMd@Author        <- "D.Kolody"
OMd@Notes         <- "OM based on 2 SS specifications without stochastic variability; 1 rep per SS configuration, R projections"
...
# --- save object --------------------------------------------------------------
save(OMd,file=paste(getwd(),"/Objects/OMd.OMyftNEr.RDA",sep=""))
