...
# --- Description --------------------------------------------------------------
OMd@Name          <- "OMbet0r"
OMd@Label         <- "OMbet0r" #useful for changing graphics labels
OMd@Date          <- "Jun 2016"
OMd@Author        <- "D.Kolody"
...
#OMd@OMList        <- as.list(gridB1List[c(1,18)]) #[c(1,2,17,18)]) #("R1P1_h70_M06_q0Mhigh") #gridB1List[c(1,18)])
...
# --- save object --------------------------------------------------------------
save(OMd,file=paste(getwd(),"/Objects/OMd.OMbet0r.RDA",sep=""))
