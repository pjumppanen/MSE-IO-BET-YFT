...
OMd@nsimPerOMFile <- array(rep(4,length(OMd@OMList)),dim=length(OMd@OMList))   # Number of simulations per each SS specification file (vector of length OMList allows differental weighting, i.e. c(10,50,25)
...
OMd@tunePM           <- "SBoSBMSY0.5"
OMd@tunePMProjPeriod <- 20
OMd@tunePMTarget     <- 2.5
OMd@tuneTol          <- 0.01
