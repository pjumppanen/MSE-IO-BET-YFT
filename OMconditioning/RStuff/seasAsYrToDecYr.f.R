#default arguments are set up for original YFT implementation
...
#function to convert a MSE year to a decimal year, assuming quarterly seasons, eg. for for 2013 Q1: label 2013.125
